...
<html>
	<head>
		...
		<script src="_Templates/<?=ADMIN_TEMPLATE?>/_Scripts/admin.js" type="text/javascript"></script>		
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
 ...
 <tr valign="top"><td width="30%">
			 ...
			 <div style="padding-left:5px;">
				 <div class="head">Создать пользователя:</div>
				 <span title='новый пользователь'><a href='?page=admin&action=adminedit&aid=-1'><img src='_Templates/<?=ADMIN_TEMPLATE?>/_Images/icon_admin.gif' border='0'></a></span>
				</div>
			 </fieldset>
 			 <fieldset class="list">
			...
			<?
				...
				for ($i = 0; $i < sizeof($adm_list); $i++)	{
					...
					if (strlen($tmpname) > $sysProperties["headlength"]) $tmpname = substr($tmpname, 0, $sysProperties["headlength"]);
						 	...
						 	echo $tmpname . "</a>";
							if ($adm_list[$i]["active"] == 0) echo "<span class='blockeduser'>заблокирован</span>";
							echo "</td><td>";
