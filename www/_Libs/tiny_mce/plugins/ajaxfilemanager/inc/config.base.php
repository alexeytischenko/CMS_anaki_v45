...
//error_reporting(E_ALL ^ E_NOTICE);
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../../../../_Upload/users/user_'.$_SESSION["zona_uid"].'/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../../../../_Upload/users/user_'.$_SESSION["zona_uid"].'/');	//accept relative path only
	define('CONFIG_SYS_FOLDER_SHOWN_ON_TOP', true); //show your folders on the top of list if true or order by name
	define("CONFIG_SYS_DIR_SESSION_PATH", '../../../../../../_Upload/session/');
	...
	define('CONFIG_EDITOR_NAME', 'tinymce');//(CONFIG_QUERY_STRING_ENABLE && !empty($_GET['editor'])?secureFileName($_GET['editor']):'stand_alone'));
