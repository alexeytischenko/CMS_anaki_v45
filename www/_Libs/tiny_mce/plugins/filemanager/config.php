<?php
        ...
        $mcFileManagerConfig['filesystem.path'] = '../../../../_Upload/_editorfiles/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = '../../../../_Upload/_editorfiles/'; // absolute or relative from this script path.
        ...
        $mcFileManagerConfig['filesystem.extensions'] = "pdf,zip,txt,doc,docx,rtf,png,swf,dcr,mov,qt,ram,rm,avi,mp3,mpg,mpeg,asf,flv";
        ...
        $mcFileManagerConfig['upload.extensions'] = "mp3,pdf,zip,txt,doc,docx,rtf";
