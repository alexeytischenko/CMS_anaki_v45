<?php
	...
	require_once($basepath . "ImageManager/ImageManagerPlugin.php");
        ...
        $mcImageManagerConfig['filesystem.path'] = '../../../../_Upload/_editorimages/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../../_Upload/_editorimages/'; // absolute or relative from this script path, required.
        ...
        $mcImageManagerConfig['favorites.max'] = 0; // 10 is default.
        $mcImageManagerConfig['history.max'] = 0; // 10 is default.
?>